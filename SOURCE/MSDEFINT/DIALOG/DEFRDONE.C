/*    
   Chkargs.c - defragmentation done dialog.
...
static struct SelectButton SelectButtons[] =
          {{"Reboot the computer.", TRUE, WHITE, PUSHLEN, 0, AD, 3, NULL},
           {"Exit defrag.", FALSE, WHITE, PUSHLEN, 1, AD, 3, NULL},
